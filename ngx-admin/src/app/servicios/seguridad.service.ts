...
export class SeguridadService {
   ...
   * @returns true si hay una sesión activa, false de lo contrario.
   */

  /**
   * Verifica si hay una sesión activa y redirige a la página de inicio de sesión si no hay sesión.
   */
  verificarSesionYRedirigir(): void {
    if (!this.sesionExiste()) {
  ...
  * @returns Respuesta HTTP la cual indica si el usuario tiene permiso de
  acceso
  */
